    ...
    return (
        <>
            ...
            <div
                ...
                className={cn(
                    'absolute transform-gpu animate-orbit flex items-center justify-center rounded-full [animation-delay:calc(var(--delay)*1000ms)]',
...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
    ...
    return (
        <section className={cn('relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg', className)}>
            {children ? children : (
                <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-4xl font-bold tracking-tighter leading-none text-transparent dark:from-white dark:to-white/40'>
                    {text}
                </span>
            )}
...
const AnimatedForm = memo(function AnimatedForm({
    ...
    return (
        <section className={cn('max-md:w-full flex flex-col gap-4 w-full mx-auto', className)}>
            ...
            {subHeader && (
                <BoxReveal boxColor='var(--skeleton)' duration={0.3} width="100%" className='pb-2'>
                    <p className='text-neutral-600 text-sm max-w-sm dark:text-neutral-300 mx-auto'>
                        {subHeader}
                    </p>
                </BoxReveal>
            )}
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto">
                ...
                >
                    {fields.map((field) => (
                        <section key={field.label} className='flex flex-col gap-2 text-left'>
